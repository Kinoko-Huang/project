...
cat << End_of_namelist > namelist.input.${case}
 ...
 run_minutes                         = 0,
 run_seconds                         = 0,
 start_year                          = ${year_start}, ${year_start}, ${year_start}, ${year_start},
 start_month                         = ${month_start},   ${month_start},   ${month_start},   ${month_start},
 start_day                           = ${day_start},   ${day_start},   ${day_start},	 ${day_start},
 start_hour                          = ${hour_start},   ${hour_start},   ${hour_start},	 ${hour_start},
 start_minute                        = 00,   00,   00,	 00,	
 start_second                        = 00,   00,   00,	 00,
 end_year                            = ${year_end}, ${year_end}, ${year_end}, ${year_end},
 end_month                           = ${month_end},   ${month_end},   ${month_end},	 ${month_end},
 end_day                             = ${day_end},   ${day_end},   ${day_end},   ${day_end},
 end_hour                            = ${hour_end},   ${hour_end},   ${hour_end},	 ${hour_end},
