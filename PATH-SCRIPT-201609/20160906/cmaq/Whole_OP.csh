...
####      if ( "$DOMAINS_GRID" == "1" ) then
####        echo Run ./run.OP.mpich2_cold $CUR_JDATE $ICON_path $ICON_file $DOMAINS_GRID
####        ./run.OP.mpich2_cold $CUR_JDATE $ICON_path $ICON_file $DOMAINS_GRID
####        if ( $status != 0 ) then
####          echo Failed: ./run.OP.mpich2_cold $CUR_JDATE $ICON_path $ICON_file $DOMAINS_GRID
####          exit 1
####        endif
####      else
####        echo Run ./run.OP.mpich2_cold $CUR_JDATE $ICON_path $ICON_file $DOMAINS_GRID
...
####      endif
####    else
####      echo Run ./run.OP.mpich2 $CUR_JDATE $ICON_path $ICON_file $DOMAINS_GRID
####      ./run.OP.mpich2 $CUR_JDATE $ICON_path $ICON_file $DOMAINS_GRID
####      if ( $status != 0 ) then
####        echo Failed: ./run.OP.mpich2 $CUR_JDATE $ICON_path $ICON_file $DOMAINS_GRID
####        exit 1
####      endif
####    endif
